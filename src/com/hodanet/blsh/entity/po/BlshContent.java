 ...
 */
@Entity
@Table(name = "blsh_content")
public class BlshContent {
    ...
    public String getTypeStr() {
        return BlshContentType.getBlshContentType(type).getTip();
    }

    public String getStatusStr() {
        return BlshContentStatus.getBlshContentStatus(status).toString();
    }
